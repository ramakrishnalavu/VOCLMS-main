  ...
  return (
    <div>
      ...
      <div className="grid grid-4 gap-4 mb-6">
        ...
        <StatCard emoji="⚠️" label="Expiring Soon"      value={count(contracts,'status','EXPIRING')}             accent="#f97316" />
      ...
      <div className="card">
        ...
        <div className="grid grid-2 gap-4">
          {[
            ...
            ['1️⃣', 'Stage 1: Procurement', 'PROCUREMENT_OFFICER must approve before Legal Verification begins'],
            ['2️⃣', 'Stage 2: Legal',       'LEGAL_TEAM must verify all documents before Finance Approval'],
            ['3️⃣', 'Stage 3: Finance',     'FINANCE_TEAM approval completes the onboarding process'],
